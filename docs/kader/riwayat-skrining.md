---
sidebar_position: 3
title: Cara Melihat Riwayat Skrining Mandiri
---

# Cara Melihat Riwayat Skrining Mandiri

Halaman **Riwayat Skrining** menyimpan seluruh data warga yang pernah diinput oleh Bapak/Ibu Kader secara mandiri.

---

## 1. Membuka Riwayat Pemeriksaan

- **Langkah 1:** Klik menu **Riwayat Skrining** pada menu sebelah kiri.
- **Langkah 2:** Bapak/Ibu Kader akan melihat daftar nama warga yang pernah diperiksa beserta status hasilnya.
...
## 2. Mengedit atau Memperbaiki Data yang Salah

- Jika terdapat kesalahan penulisan nama atau NIK warga, klik tombol **[Edit]** pada baris nama warga tersebut.
- Perbaiki data yang salah, lalu klik tombol **[Simpan Perubahan]**.
